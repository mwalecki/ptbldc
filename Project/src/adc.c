...
void ADCwithDMA_Config(void){
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_0, 1, ADC_SampleTime_71Cycles5); //INP1
	ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 2, ADC_SampleTime_71Cycles5); //INP2
	ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 3, ADC_SampleTime_71Cycles5); //INP3
	ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 4, ADC_SampleTime_71Cycles5); //INP4
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_12, 9, ADC_SampleTime_71Cycles5); //SEN12
	ADC_RegularChannelConfig(ADC1, ADC_Channel_13, 10, ADC_SampleTime_71Cycles5); //SEN5
	ADC_RegularChannelConfig(ADC1, ADC_Channel_14, 11, ADC_SampleTime_71Cycles5); //ISEN1
	ADC_RegularChannelConfig(ADC1, ADC_Channel_15, 12, ADC_SampleTime_71Cycles5); //ISEN2
	/* Enable ADC1 DMA */
